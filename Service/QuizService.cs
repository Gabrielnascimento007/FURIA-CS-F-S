...
public static class QuizService
{
    ...
    {
    ("Quem é o IGL da FURIA?", new[] { "chelo", "arT", "FalleN", "KSCERATO" }, 1, "✅ arT é o In-Game Leader da FURIA!"),
    ("Qual jogador é conhecido por jogadas agressivas?", new[] { "saffee", "chelo", "arT", "yuurih" }, 2, "✅ arT é famoso pelas entries kamikazes!"),
    ...
    ("Quem é o AWPer principal da FURIA?", new[] { "yuurih", "chelo", "saffee", "arT" }, 2, "✅ saffee é o principal AWPer da FURIA!"),
    ...
    ("Quem é o capitão da FURIA?", new[] { "chelo", "yuurih", "arT", "saffee" }, 2, "✅ arT é o capitão do time."),
